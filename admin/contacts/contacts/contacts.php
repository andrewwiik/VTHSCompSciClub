...
switch($_GET["action"]){
	...
	case "edit":
		...
		$query->bind_param('sssssssssssi', $_POST['fname'], $_POST['lname'], $_POST['address'], $_POST['city'], $_POST['zipcode'], $_POST['mnumber'], $_POST['lnumber'], $_POST['relation'], $_POST['email'], $file, $id);
		$query->execute();
		$mysqli->close();
	break;
