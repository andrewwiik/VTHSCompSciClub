...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" action="search_results.html">
                <div class="form-group">
                    <input type="text" placeholder="Search for something..." class="form-control" ng-model="contactFilter" name="top-search" id="top-search">
                </div>
            </form>
        </div>
                ...
                <div class="contact-box">
                    ...
                    <div class="col-sm-4">
                        <div class="text-center">
                            <img alt="image" class="img-circle m-t-xs img-responsive" src="{{ contact.photo }}">
                            <div class="m-t-xs font-bold">{{ contact.relation }}</div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                        <h3><strong>{{ contact.fname }}  {{ contact.lname }}</strong></h3>
                        <p><i class="fa fa-map-marker"></i> {{ contact.city }}  {{ contact.zipcode }}</p>
                        <address>
                            <strong>{{ contact.fname }} {{ contact.lname }}</strong><br>
                            {{ contact.address }}<br>
                            {{ contact.city }}, {{ contact.zipcode }}<br>
                            <abbr title="Phone">P:</abbr> {{ contact.mnumber }}
                        </address>
                    </div>
        ...
        <div class="footer">
            ...
            <div>
                <strong>Copyright</strong> Andrew Wiik &copy; 2014-2015
            </div>
        </div>
